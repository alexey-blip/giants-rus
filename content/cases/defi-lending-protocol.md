...
{{< cta title="Разработаем токеномику для вашего DeFi-протокола" text="Мы проектируем модели утилизации, bonding curves и механизмы управления рисками для кредитных платформ, DEX и других DeFi-протоколов." button="Обсудить проект" link="https://t.me/karanyuk" >}}
