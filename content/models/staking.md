...
<li><strong>Блокировка дифференцирована</strong> — больше срок блокировки = больше награда</li>
...
{{< cta title="Спроектируем экономику стейкинга для вашего протокола" text="Мы моделировали стейкинг для PoS-сетей, DeFi-протоколов и liquid staking платформ. Рассчитаем оптимальные параметры и проверим устойчивость на 5 лет." button="Обсудить стейкинг" link="https://t.me/karanyuk" >}}
