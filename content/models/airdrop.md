...
{{< cta title="Проектируем airdrop для вашего протокола" text="Мы спроектировали модели распределения для 85+ проектов — от DeFi до GameFi. Рассчитаем оптимальный размер пула, критерии и защиту от сибил-атак." button="Обсудить airdrop" link="https://t.me/karanyuk" >}}
